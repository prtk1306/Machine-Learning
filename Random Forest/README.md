...
Case study: To predict the salary of an ex-employee who claims to be on the Region Manager Level with $160000 Salary. Predict if the employee is honest or not. Use Random Forest algorithm and predict the Salary of an ex-employee and check whether an employee is lying or not. 
